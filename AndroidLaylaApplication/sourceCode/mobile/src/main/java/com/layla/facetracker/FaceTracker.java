...
import com.layla.R;
import com.layla.facetracker.ui.camera.CameraSourcePreview;
import com.layla.facetracker.ui.camera.GraphicOverlay;
import com.layla.modules.HeartRateMonitor;
...
public final class FaceTracker extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        buttonPhoto = findViewById(R.id.button1);
    ...
    {
        note.put("autoMood", happiness);
        note.saveInBackground(e -> Toast.makeText(FaceTracker.this, "Successful save!",
    ...
    {
        Log.e("LAYLA", "Camera permission is not granted. Requesting permission");
    ...
    private void createCameraSource()
    {
        ...
        if(!detector.isOperational())
        {
            ...
            Log.e("LAYLA", "Face detector dependencies are not yet available.");
        }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
    {
        ...
        {
            Log.e("LAYLA", "Got unexpected permission result: " + requestCode);
        ...
        {
            Log.e("LAYLA", "Camera permission granted - initialize the camera source");
            // we have permission, so create the camerasource
            createCameraSource();
            return;
        }

        Log.e("LAYLA", "Permission not granted: results len = " + grantResults.length +
    ...
    private void startCameraSource()
    {
        ...
        if(mCameraSource != null)
        {
            ...
            {
                Log.e("LAYLA", "Unable to start camera source.", e);
                mCameraSource.release();
                mCameraSource = null;
            }
        }
    ...
    private class GraphicFaceTracker extends Tracker<Face>
    {
        ...
        {
            happiness=item.getIsSmilingProbability();
